...
\begin{enumerate}
  \item Forced grudging coalitions with rotten compromises and many disputes.
...
has a level of detail that is very difficult to achieve in such a Google Docs document.
This document, on the other hand, explains the why and wherefore. This is only included in a very
