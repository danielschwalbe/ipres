...
Parteien scheiden in jedem Schritt mindestens $\lfloor n(1-r) \rfloor$ Parteien aus.
Ohne Beschränkung der Allgemeinheit können wir annehmen, dass in jedem Wahlgang $\forall i:
a_i \neq 0$ gilt. Sollte in der Praxis doch jemals eine Partei gar keine Stimme erhalten,
nehmen wir diese aus der Liste und reduzieren $n$ entsprechend.
