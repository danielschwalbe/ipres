...
\begin{proof}
Durch Widerspruch. Annahme: $\displaystyle\sum_{i=n-k+1}^{n} a_i > \frac{k}{n}$. Da die
Gesamtsumme~1 ist, folgt:
\begin{equation}
  \sum_{i=1}^{n-k} a_i = 1 - \sum_{i=n-k+1}^{n} a_i < 1 - \frac{k}{n} = \frac{n-k}{n}
\end{equation}
Also muss mindestens eines der ersten $n-k$ Elemente kleiner als $\frac{1}{n}$ sein. Da die
