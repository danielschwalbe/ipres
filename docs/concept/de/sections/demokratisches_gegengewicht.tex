...
Vor der eigentlichen Diskussion zunächst eine Begriffsklärung. Man kann verschieden starke Mehrheiten definieren, z.B.:

{\renewcommand{\arraystretch}{1.4}%
\renewcommand{\tabularxcolumn}[1]{m{#1}}%
\begin{tabularx}{\linewidth}{| >{\arraybackslash}m{4.2cm} | X | >{\raggedleft\arraybackslash}m{3.5cm} |}
  \hline
