...
Dann könnte die Fraktion, wie bisher, in Eigenregie den Bundeskanzler stürzen, wenn sie sich denn einig wäre.
...
Um das zu verhindern, ist nach Artikel 46 Absatz 2 und3 des Grundgesetzes die Genehmigung des Bundestages für Strafverfolgung und jede Einschränkung der persönlichen Freiheit eines Abgeordneten erforderlich.
...
\runinhead{Es gibt grundsätzlich zwei Fälle zu unterscheiden:}
\begin{enumerate}
    \item Der Bundeskanzler verstößt gegen die Verfassung und lässt sich durch das Bundesverfassungsgericht nicht korrigieren.
    \item Der Bundeskanzler ist sonst wie kriminell.
\end{enumerate}
