...
somit die Wahl gewonnen und bekommt die absolute Mehrheit zugesprochen.

Da es sich nur um eine
...
Volkswillen entspräche.

Wenn im ersten Wahlgang eine Partei oder Koalition 70\,\% der Stimmen auf
...
entschieden werden, sondern von einer Gruppe von Menschen.

Man geht aber davon aus, dass Menschen
...
Fraktion ist, desto schwieriger wird im Allgemeinen eine Einigung sein.
...
Konsens vortäuschen würde, als tatsächlich vorhanden.

Die Regierungspartei hat im Sinne des
...
wir leben weiter in dem von den (geistigen) Vätern vorgegebenen Rahmen.

Das Prinzip stößt nur an
...
dass notwendigerweise die geforderte Zweidrittelmehrheit zustande kommt.
...
\subsection{Demokratisches Gegengewicht}

Durch das vorgeschlagene Wahlverfahren bekommt die Regierung effektiv erheblich mehr Macht. Dafür muss an anderer Stelle ein
demokratischer Ausgleich geschaffen werden, damit die Gefahr des Festsetzens an der Macht wieder verringert wird.
