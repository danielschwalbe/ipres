...
thus won the election and is awarded the absolute majority.
...
If in the first round a party or coalition were to unite 70\,\% of the votes,
...
decided by individuals, but by a group of people.

However, one assumes that people
...
faction is, the more difficult an agreement will generally be.
...
The governing party has received more power in the sense of the
...
we continue to live within the framework set by the (intellectual) fathers.

The principle only reaches
...
the required two-thirds majority necessarily being achieved.
